...
class InstanceOperator(Operator):
    ...
    def add(self):
        ...
        self.operator_return['message'] = "To add Instance object succeed: %s\n" % validate_result['name']
    ...
    def pillarSet(self):
        ...
        self.operator_return['message'] += "To set pillar for instance '%s' succeed.\n" % obj.name
        return self.operator_return
    ...
    def pillarDel(self):
        ...
        self.operator_return['message'] = "To delete pillar '%s' of instance '%s' succeed in environment '%s'.\n" % (validate_result['pillar_name'], obj.name, environment)
        return self.operator_return
    ...
    def lock(self):
        ...
        self.operator_return['message'] = 'To lock Instance object succeed: %s\n' % validate_result['name']
        return self.operator_return
    ...
    def unlock(self):
        ...
        self.operator_return['message'] = 'To unlock Instance object succeed: %s\n' % validate_result['name']
        return self.operator_return
    ...
    def show(self):
        ...
        for obj in queryset.order_by('id'):
            if 'longTerms' in self.parameters and '--short' in validate_result['longTerms']:
                ...
                if  '--commandline' in validate_result['longTerms']:
